    ...
    * */
    beforeSubmit: async ({
      ...
      if(form.id === "app/routes/new-post.mdx")
        ...
        postSlug = form.id.replace('app/routes/fizzy.', '/fizzy/').replace(/\.mdx$/, '');
    ...
    router: ({ document }) => {
      ...
      return `/fizzy/${document._sys.basename.replace('fizzy.', '').replace('.mdx', '')}`;
    },
    filename: {
